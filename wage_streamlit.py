...
df_jp_ind = pd.read_csv('C:/Users/AtsushiKAMIYA/workspace/lec_streamlit/analysis_jp_wage/csv_data/雇用_医療福祉_一人当たり賃金_全国_全産業.csv', encoding='shift_jis')
df_jp_category = pd.read_csv('C:/Users/AtsushiKAMIYA/workspace/lec_streamlit/analysis_jp_wage/csv_data/雇用_医療福祉_一人当たり賃金_全国_大分類.csv', encoding='shift_jis')
df_pref_ind = pd.read_csv('C:/Users/AtsushiKAMIYA/workspace/lec_streamlit/analysis_jp_wage/csv_data/雇用_医療福祉_一人当たり賃金_都道府県_全産業.csv', encoding='shift_jis')

st.header('■2019年：一人当たり平均賃金ヒートマップ')

jp_lat_lon = pd.read_csv('C:/Users/AtsushiKAMIYA/workspace/lec_streamlit/analysis_jp_wage/pref_lat_lon.csv')
#RESASの都道府県名というカラム名に合わせるため、ヘッダーをリネーム
